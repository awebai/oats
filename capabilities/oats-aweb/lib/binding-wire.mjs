...
function teamFromSettings(settings) {return typeof settings.team==='string' && settings.team.trim()?settings.team.trim():undefined;}
function rootCandidate(settings,team) {
  ...
  return {root:fallback,key:'settings.oats.aweb.root',declared:false};
}
