...
adds it; **1.11.2** (OATS >=0.24.4) declares its fixed reasons so the kernel can show them and omits its briefing from harvest helpers. It and qualifies only an input-capable Claude/Codex profile with explicit
