// CLASSIC-scope OKF fixture, kept ONLY for the capability-agent tests that wait on the
// lead's question Q1 (a prepared spawn for capability agents on a workspace deployment:
// notes/design-c3-plan.md). Delete it with them when Q1 lands; everything else uses
// test/helpers/okf-v2.mjs.
