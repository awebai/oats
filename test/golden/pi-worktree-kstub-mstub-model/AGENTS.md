...
<!-- oats:capability:golden.knowledge src=<base>/deployment/agents/dev/instances/dev-pi-worktree-kstub-mstub-model/.oats/modules/golden.knowledge/inject.md -->
## Knowledge (stub)
...
<!-- oats:capability:golden.messaging src=<base>/deployment/agents/dev/instances/dev-pi-worktree-kstub-mstub-model/.oats/modules/golden.messaging/inject.md -->
## Messaging (stub)
