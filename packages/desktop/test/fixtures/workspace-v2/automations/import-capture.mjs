// Import the automations capture (kernel 2b #213, feature automations, automationsApi 1):
...
const documents = ['version', 'sync', 'schedule-add-local', 'trigger-add-local', 'trigger-list', 'schedule-list', 'trigger-test-here', 'trigger-test-mismatch',
  'trigger-disable', 'trigger-list-disabled', 'trigger-enable', 'schedule-disable', 'schedule-enable', 'schedule-run-elsewhere', 'schedule-remove-workspace',
  'trigger-remove-workspace', 'workspace-status', 'automations-refresh'];
