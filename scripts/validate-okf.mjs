...
// okf 4.0.0: the validator CLI lives in the knowledge-slot capability's lib/ (the okf skill was removed).
const validator = join(root, "capabilities", "oats-okf", "lib", "okf-validate.mjs");
