...
**Team review (Antares, 2026-09-23) folded in:** rebuild guide (W10), `--provider` instance payload (W6/W7), drift display (W7), duplicate-name rule (W6), 0.24.x-keeps-working stated everywhere.
