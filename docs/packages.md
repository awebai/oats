...
```json
{
  "packages": {
    ...
    "oats.framework": { "url": "https://github.com/awebai/oats.git", "ref": "oats-framework/v1.1.2", "path": "oats-package" },
...
entry selects the published `oats-framework/v1.1.2` tag, which exports three
