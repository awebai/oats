...
replies and other endpoints cannot. A server-generation counter, bumped when
a backend is invalidated, stops a late reply from a replaced backend
restoring its old list. Off-origin resolution is still rejected before
