...
const STATUSES = new Set(["scaffolded-hooks-pending", "spawn-hooks-running", "spawned-launch-pending", "spawn-failed-cleanup-required", "retire-running", "retire-failed-cleanup-required"]);
...
export function validateCapturedInstanceReference(row) {
  objectAt(row,["home","instance","agent","kind","status","executionBinding","responsibleHuman","incarnationId","custody","intents"],
