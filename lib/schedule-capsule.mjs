...
const PREPARATION_FIELDS = Object.freeze(["deployment", "source", "workspace", "member", "operator", "mode"]);
...
export function validatePreparationInput(value) {
  ...
  if (value.mode !== undefined && (typeof value.mode !== "string" || !value.mode.trim())) throw oatsError("invalid-declaration", "preparation mode must be a work-mode string");
