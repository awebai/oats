...
export function listResolutionEvidence(scope, { maxRecords = 4096, includeDocuments = false } = {}) {
  if (!Number.isSafeInteger(maxRecords) || maxRecords < 1 || maxRecords > 10_000 || typeof includeDocuments !== "boolean") {
