...
const PRIORITY = Object.freeze({ "workspace-default": 0, "soul-default": 1, "import-adoption": 2, operator: 3 });
  ...
  for (const key of [...groups.keys()].sort(compareUtf8)) {
    ...
    for (const candidate of input.candidates) {
      ...
      if (incompatible) {
        ...
        considered.push({ value: candidate.value, origin: candidate.origin, disposition: "overridden" });
        continue;
      }
