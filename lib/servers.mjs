...
export function attachArgv(serverId, { instance, home } = {}) {
  ...
  if (!remoteHome || !String(remoteHome).startsWith("/")) throw serverError("E_BAD_ARGS", "session attach --server needs --instance <name> (spawned from here) or --home </absolute/remote/home>");
