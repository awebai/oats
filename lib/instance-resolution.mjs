...
import { loadLocal, discoverWorkspace, standaloneRepo } from "./workspace.mjs";
...
export async function prepareInstance(contextDir, soulName, { spawn = {}, remoteOptions, local: localOverride, discovery: discoveryOverride } = {}) {
  ...
  const discovery = discoveryOverride ?? await discoverWorkspace(local.workspace, { local, remoteOptions });
