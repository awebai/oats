...
import {
  DEFAULT_PACKAGE_PATH, OATS_LOCK_FILE, OAS_SCOPE_FILES, detectOasScopes, findRoot, listAgents, listInstalledPackages, loadPackageManifestAt, packageSpecIdentity,
 ...
 * local-agents, and nested team boundaries are skipped. `visit` is called on
 * every surviving directory in deterministic path order; the boundary itself
 * is not visited. */
